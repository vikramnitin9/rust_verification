...
void _avocado___builtin_ia32_sfence(void)
{
  __asm("sfence");
}
...
void _avocado___builtin_ia32_lfence(void)
{
  __asm("lfence");
}
...
void _avocado___builtin_ia32_mfence(void)
{
  __asm("mfence");
}
...
void _avocado___sync_synchronize(void)
{
...
void _avocado___atomic_thread_fence(int memorder);

_Bool _avocado___atomic_test_and_set(void *ptr, int memorder)
{
__CPROVER_HIDE:;
  __CPROVER_atomic_begin();
  _Bool result = *(char *)ptr == 1;
  *(char *)ptr = 1;
  _avocado___atomic_thread_fence(memorder);
...
void _avocado___atomic_clear(_Bool *ptr, int memorder)
{
__CPROVER_HIDE:;
  __CPROVER_atomic_begin();
  *(char *)ptr = 0;
...
void _avocado___atomic_signal_fence(int memorder)
{
__CPROVER_HIDE:;
  _avocado___atomic_thread_fence(memorder);
}
...
_Bool _avocado___atomic_always_lock_free(__CPROVER_size_t size, void *ptr)
{
__CPROVER_HIDE:;
  (void)ptr;
...
_Bool _avocado___atomic_is_lock_free(__CPROVER_size_t size, void *ptr)
{
__CPROVER_HIDE:;
  (void)ptr;
  return size <= sizeof(__CPROVER_size_t);
...
short _avocado___builtin_ia32_vec_ext_v4hi(__gcc_v4hi vec, int offset)
{
...
short _avocado___builtin_ia32_vec_ext_v8hi(__gcc_v8hi vec, int offset)
{
  return *((short *)&vec + offset);
}
...
int _avocado___builtin_ia32_vec_ext_v4si(__gcc_v4si vec, int offset)
{
...
long long _avocado___builtin_ia32_vec_ext_v2di(__gcc_v2di vec, int offset)
{
...
int _avocado___builtin_ia32_vec_ext_v16qi(__gcc_v16qi vec, int offset)
{
...
float _avocado___builtin_ia32_vec_ext_v4sf(__gcc_v4sf vec, int offset)
{
...
__gcc_v8hi _avocado___builtin_ia32_psubsw128(__gcc_v8hi a, __gcc_v8hi b)
{
...
__gcc_v8hi _avocado___builtin_ia32_psubusw128(__gcc_v8hi a, __gcc_v8hi b)
{
  typedef unsigned short v8hi_u __attribute__((__vector_size__(16)));
...
__gcc_v4hi _avocado___builtin_ia32_paddsw(__gcc_v4hi a, __gcc_v4hi b)
{
...
__gcc_v4hi _avocado___builtin_ia32_psubsw(__gcc_v4hi a, __gcc_v4hi b)
{
  return __CPROVER_saturating_minus(a, b);
}
...
__gcc_v4hi _avocado___builtin_ia32_vec_init_v4hi(short e0, short e1, short e2, short e3)
{
