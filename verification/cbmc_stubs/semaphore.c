...
int _avocado_sem_init(sem_t *sem, int pshared, unsigned int value)
{
  __CPROVER_HIDE:;
  (void)pshared;
  (void)value;
...
int _avocado_sem_wait(sem_t *sem)
{
  __CPROVER_HIDE:;
  (void)sem;
...
int _avocado_sem_timedwait(sem_t *sem, const struct timespec *abstime)
{
  __CPROVER_HIDE:;
  (void)sem;
  (void)abstime;
...
int _avocado_sem_trywait(sem_t *sem)
{
  __CPROVER_HIDE:;
  (void)sem;
...
int _avocado_sem_post(sem_t *sem)
{
  __CPROVER_HIDE:;
  (void)sem;
...
int _avocado_sem_post_multiple(sem_t *sem, int number)
{
  __CPROVER_HIDE:;
  (void)sem;
  (void)number;
...
int _avocado_sem_getvalue(sem_t *sem, int *sval)
{
  __CPROVER_HIDE:;
  (void)sem;
  (void)sval;
...
int _avocado_sem_destroy(sem_t *sem)
{
  __CPROVER_HIDE:;
  (void)sem;
