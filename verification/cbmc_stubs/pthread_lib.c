...
int _avocado_pthread_mutexattr_settype(pthread_mutexattr_t *attr, int type)
{
  __CPROVER_HIDE:;
...
int _avocado_pthread_cancel(pthread_t thread)
{
  __CPROVER_HIDE:;
...
#ifdef __CPROVER_CUSTOM_BITVECTOR_ANALYSIS
void _avocado_pthread_mutex_cleanup(void *p)
{
  __CPROVER_HIDE:;
  __CPROVER_assert(
...
int _avocado_pthread_mutex_init(
...
int _avocado_pthread_mutex_lock(pthread_mutex_t *mutex)
{
  __CPROVER_HIDE:;
  #ifdef __CPROVER_CUSTOM_BITVECTOR_ANALYSIS
...
int _avocado_pthread_mutex_trylock(pthread_mutex_t *mutex)
{
  __CPROVER_HIDE:;
  int return_value;
  __CPROVER_atomic_begin();
...
int _avocado_pthread_mutex_unlock(pthread_mutex_t *mutex)
{
  __CPROVER_HIDE:;
...
int _avocado_pthread_mutex_destroy(pthread_mutex_t *mutex)
{
  __CPROVER_HIDE:;
...
void _avocado_pthread_exit(void *value_ptr)
{
  __CPROVER_HIDE:;
...
int _avocado_pthread_join(pthread_t thread, void **value_ptr)
{
__CPROVER_HIDE:;
...
int _avocado__pthread_join(pthread_t thread, void **value_ptr)
{
__CPROVER_HIDE:;
...
int _avocado_pthread_rwlock_destroy(pthread_rwlock_t *lock)
{
  __CPROVER_HIDE:;
...
#ifdef __CPROVER_CUSTOM_BITVECTOR_ANALYSIS
void _avocado_pthread_rwlock_cleanup(void *p)
{
  __CPROVER_HIDE:;
...
int _avocado_pthread_rwlock_init(
...
int _avocado_pthread_rwlock_rdlock(pthread_rwlock_t *lock)
{
  __CPROVER_HIDE:;
  __CPROVER_atomic_begin();
...
int _avocado_pthread_rwlock_tryrdlock(pthread_rwlock_t *lock)
{
  __CPROVER_HIDE:;
  __CPROVER_atomic_begin();
...
int _avocado_pthread_rwlock_trywrlock(pthread_rwlock_t *lock)
{
  __CPROVER_HIDE:;
  __CPROVER_atomic_begin();
...
int _avocado_pthread_rwlock_unlock(pthread_rwlock_t *lock)
{
  __CPROVER_HIDE:;
  __CPROVER_assert(*((signed char *)lock)==1,
    "must hold lock upon unlock");
...
int _avocado_pthread_rwlock_wrlock(pthread_rwlock_t *lock)
{
  __CPROVER_HIDE:;
  __CPROVER_atomic_begin();
  __CPROVER_assert(*((signed char *)lock)!=-1,
...
void _avocado___spawned_thread(
  ...
  void *arg)                      // may be null
{
  ...
  *thread=(pthread_t)this_thread_id;
  ...
  // Destructor support is disabled as it is too expensive due to its extensive
  // use of shared variables.
  void (**_avocado_thread_key_dtors)(void *) = __CPROVER_thread_key_dtors;
#endif

  __CPROVER_ASYNC_1:
    _avocado___spawned_thread(
      this_thread_id,
#if 0
...
int _avocado_pthread_cond_init(pthread_cond_t *cond, const pthread_condattr_t *attr)
{ __CPROVER_HIDE:
  *((unsigned *)cond)=0;
  if(attr) (void)*attr;
  return 0;
...
int _avocado_pthread_cond_signal(pthread_cond_t *cond)
{ __CPROVER_HIDE:
  __CPROVER_atomic_begin();
  (*((unsigned *)cond))++;
  __CPROVER_atomic_end();
...
int _avocado_pthread_cond_broadcast(pthread_cond_t *cond)
{ __CPROVER_HIDE:
  __CPROVER_atomic_begin();
...
int _avocado_pthread_cond_wait(pthread_cond_t *cond, pthread_mutex_t *mutex)
{ __CPROVER_HIDE:
...
#ifndef __APPLE__
int _avocado_pthread_spin_lock(pthread_spinlock_t *lock)
{
  __CPROVER_HIDE:;
  __CPROVER_atomic_begin();
...
// no pthread_spinlock_t on the Mac
#ifndef __APPLE__
int _avocado_pthread_spin_unlock(pthread_spinlock_t *lock)
{
  __CPROVER_HIDE:;
...
// no pthread_spinlock_t on the Mac
#ifndef __APPLE__
int _avocado_pthread_spin_trylock(pthread_spinlock_t *lock)
{
  __CPROVER_HIDE:;
  int result;
  __CPROVER_atomic_begin();
...
int _avocado_pthread_barrier_init(
...
// no pthread_barrier_t on the Mac
#ifndef __APPLE__
int _avocado_pthread_barrier_destroy(pthread_barrier_t *barrier)
{
  __CPROVER_HIDE:;
...
// no pthread_barrier_t on the Mac
#ifndef __APPLE__
int _avocado_pthread_barrier_wait(pthread_barrier_t *barrier)
{
  __CPROVER_HIDE:;
...
int _avocado_pthread_key_create(pthread_key_t *key, void (*destructor)(void *))
{
__CPROVER_HIDE:;
...
int _avocado_pthread_key_delete(pthread_key_t key)
{
__CPROVER_HIDE:;
...
void *_avocado_pthread_getspecific(pthread_key_t key)
{
__CPROVER_HIDE:;
...
int _avocado_pthread_setspecific(pthread_key_t key, const void *value)
{
__CPROVER_HIDE:;
