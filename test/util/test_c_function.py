...
from util.parsec_file import ParsecResult


def test_get_source_code() -> None:
    parsec_file = ParsecResult(Path("data/qsort.c"))
...
def test_get_source_code_with_docs_double_slash() -> None:
    parsec_file = ParsecResult(Path("test/data/get_source_code/test_with_doc_comments.c"))
...
def test_get_source_code_on_one_line() -> None:
    parsec_file = ParsecResult(Path("test/data/get_source_code/test.c"))
...
def test_get_comment_no_comments() -> None:
    parsec_file = ParsecResult(Path("test/data/get_comments/test.c"))
    expected_function = parsec_file.get_function_or_none("f2")
...
def test_is_self_recursive_is_true() -> None:
    parsec_file = ParsecResult(Path("test/data/callgraph/self_recursion.c"))
...
def test_is_self_recursive_is_false() -> None:
    parsec_file = ParsecResult(Path("test/data/callgraph/simple.c"))
