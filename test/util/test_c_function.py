...
def test_get_comment_no_comments() -> None:
    ...
    assert function.get_preceding_lines_starting_with_comment_delimiters() is None
...
def test_get_comment_double_slash() -> None:
    ...
    assert function.get_preceding_lines_starting_with_comment_delimiters() == expected_comments
...
def test_get_comment_multi_line() -> None:
    ...
    assert function.get_preceding_lines_starting_with_comment_delimiters() == expected_comment
