...
The function pointer restriction directive is needed to inform CBMC that we only expect the contract function `arr_fun_contract` to be called where `arr_fun` is called.
